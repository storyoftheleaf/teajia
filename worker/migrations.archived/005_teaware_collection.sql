-- Teaware Collection: dedicated table for personal teaware collection
-- Organised by category (type of item), with separate photos table
...
-- Index for fast photo lookups by teaware item
