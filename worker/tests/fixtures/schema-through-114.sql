...
CREATE INDEX idx_articles_account_status ON articles(account_id, status);
CREATE INDEX idx_articles_published_at ON articles(published_at DESC);
CREATE UNIQUE INDEX idx_articles_account_source_event ON articles(account_id, source_event_id) WHERE source_event_id IS NOT NULL;
