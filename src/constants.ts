...
export const STARTER_TEA_SETS: StarterSet[] = [
  {
    ...
    description: 'Everything you need to begin your tea journey with intention and presence. Perfect for beginners looking to establish a daily tea practice with three distinct tea varieties.',
...
export const STARTER_TEAWARE_SETS: StarterSet[] = [
  {
    ...
    description: 'Everything you need for traditional Chinese gongfu tea ceremony. High-quality ceramic gaiwan, fairness pitcher, tasting cups, and bamboo accessories.',
  ...
  },
  {
    ...
    description: 'Perfect for daily tea brewing with modern convenience. Includes multiple infusion methods, quality strainer, and precise measuring scoop.',
  ...
  },
  {
    ...
    name: 'Travel Companion',
    shortDescription: 'Portable tea setup for brewing on the go.',
    description: 'Bring your tea practice anywhere with this portable set. Lightweight, durable vessel and accessories designed for adventure and daily commutes.',
    image: 'https://picsum.photos/400/500?random=306',
    price: '$38',
    discount: 'Save $6 vs. individual items',
    items: [
  ...
  },
  {
    ...
    description: 'Discover the subtle, delicate art of tea with minimalist elegance. This refined set includes a beautiful brewing vessel and everything for a meditative tasting experience.',
