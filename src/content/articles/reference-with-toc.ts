...
export const referenceWithToc: ReadableStory = {
  ...
  content: [
    ...
    ":::TOC_IMAGE:::Processing Methods|Tea Categories & Types|Famous Regions of Origin|Key Terminology & Glossary|The Timeline of Tea|https://picsum.photos/800/1200?random=rwt002",

    ":::CHAPTER_BOLD:::I. Processing Methods",

    ":::TEXT_DOUBLE_COL:::Understanding Processing|Every tea begins as the same plant — Camellia sinensis — yet the finished product can range from a pale, sweet white tea to a pitch-dark, earthy puerh. The difference lies entirely in processing. The decisions made in the hours and days after picking determine the category, character, and quality of the final tea. Processing is where agriculture becomes art, where the farmer's skill and intuition transform raw leaf into something worth savoring. The six major processing methods correspond roughly to the six traditional Chinese tea categories, though modern producers increasingly blur these boundaries with experimental techniques.\n\nThe Kill-Green Step|Perhaps the most critical moment in tea processing is sha qing — the kill-green step — where heat is applied to halt oxidation. The method of applying this heat fundamentally shapes the tea's character. Pan-firing in a wok, the traditional Chinese method, produces teas with a toasty, nutty quality. Steaming, the Japanese preference, preserves a vivid green color and a marine, umami-rich flavor. Baking in an oven creates something between the two. Each method denatures the same enzymes but leaves a different aromatic fingerprint on the leaf.",
    ...
    ":::TEXT_ASYMMETRIC_LEFT:::China remains the origin and spiritual home of tea, producing more variety than any other country. The major producing provinces include Fujian (oolong, white, red), Yunnan (puerh, ancient tree teas), Zhejiang (Longjing and other premium greens), Anhui (Keemun, Huangshan Mao Feng), Jiangsu (Bi Luo Chun), Guangdong (Phoenix Dan Cong), and Sichuan (early-harvest greens, Tibetan brick tea). Each region has its own terroir, cultivars, and processing traditions, making Chinese tea a subject that rewards a lifetime of study. The concept of mingcha — famous teas — dates to the Tang Dynasty, when imperial tributes established hierarchies of quality that persist, in modified form, to this day.",

    ":::STAT_BIG_NUMBER:::3,000+|Distinct named tea varieties produced in China alone",

    ":::TEXT_DOUBLE_COL:::Taiwan|Despite its small size, Taiwan produces some of the world's most sought-after oolongs. The high-mountain tea gardens of Alishan, Lishan, and Da Yu Ling benefit from cool temperatures, intense UV radiation, and persistent fog that slow leaf growth and concentrate flavor compounds. Dong Ding, the island's most traditional oolong style, is roasted over charcoal in a process that can take thirty hours. Oriental Beauty, bitten by leafhoppers, develops unique honey and muscatel notes. Taiwan's tea industry is characterized by small-scale, artisanal production and a culture of innovation that has produced GABA tea, competition-grade oolongs, and some of the most sophisticated processing in the world.\n\nJapan|Japanese tea culture is defined by two innovations: steaming as a kill-green method, which produces teas with vivid green color and intense umami; and shading, which forces tea plants to overproduce chlorophyll and amino acids. Uji in Kyoto Prefecture is the historical center of Japanese tea, producing the finest matcha and gyokuro. Shizuoka Prefecture accounts for roughly forty percent of national production. Kagoshima in southern Kyushu has emerged as a major producer of organic and single-cultivar teas. The dominant cultivar, Yabukita, accounts for over seventy percent of Japanese tea acreage.",

    ":::TEXT_SIDEBAR_RIGHT:::India & Sri Lanka|India is the world's second-largest tea producer, with Darjeeling, Assam, and the Nilgiris as its three most important regions. Darjeeling teas, grown at elevations up to 2,000 meters in the Himalayan foothills, are light, muscatel, and floral — often called the Champagne of teas. Assam produces robust, malty black teas that form the backbone of most British and Irish blends. Sri Lanka, formerly Ceylon, produces a range of styles determined largely by elevation: low-grown teas are strong and full-bodied; high-grown teas from Nuwara Eliya are delicate and citrusy.|https://picsum.photos/600/800?random=rwt005",
    ...
    ":::DEFINITION_LARGE:::Cha Qi (茶气)|The physical and psychological effect of tea on the body. Experienced as warmth, tingling, mental clarity, or a sense of calm energy. Particularly associated with aged puerh and high-quality oolongs from ancient trees. Debated by Western scientists but consistently reported by experienced tea drinkers across cultures.",
