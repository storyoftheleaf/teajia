  ...
  return (
    <div className="max-w-lg mx-auto py-12 px-6 animate-[fadeIn_0.5s_ease-out]">
      <div className="text-center mb-8">
        <p className="text-[10px] uppercase tracking-[0.2em] text-tea-text-sec mb-2">Order Status</p>
      ...
      <div className="bg-tea-surface border border-tea-border rounded-md p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <span className="text-[10px] uppercase tracking-[0.15em] text-tea-text-sec">Status</span>
      ...
      <div className="bg-tea-surface border border-tea-border rounded-md p-6 mb-6">
        <p className="text-[10px] uppercase tracking-[0.15em] text-tea-text-sec mb-3">Items</p>
        {items.map((item: any) => (
