  ...
  return (
    <div className="animate-[fadeIn_0.6s_ease-out] pb-24 md:pb-24 max-w-4xl mx-auto px-6">
      ...
      <div className="mb-16 md:mb-20">
        ...
        <p className="text-tea-text/80 leading-relaxed mb-6">
      ...
      {/* The approach */}
      <div className="mb-16 md:mb-20 bg-tea-surface p-8 md:p-12 rounded-lg">
        <h2 className="font-serif text-2xl md:text-3xl text-tea-text mb-4">
          The Approach
        </h2>
        <div className="w-12 h-[1px] bg-tea-gold mb-6" />
        <p className="text-tea-text/70 leading-relaxed mb-4">
      ...
      <div className="mb-16 md:mb-20 border-t border-tea-border pt-8">
        <p className="text-tea-text/80 leading-relaxed mb-4">
