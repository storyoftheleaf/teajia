...
import { Play, BookOpen, Headphones, Film, Share2, X, ChevronLeft, ChevronRight, Camera, Heart, Bookmark, Eye, EyeOff, LayoutGrid, Link as LinkIcon, Check, Twitter, MessageCircle, Instagram, Download, SlidersHorizontal, ChevronDown, ChevronUp, ShoppingBag, List, ArrowUpDown, ArrowUp, ArrowDown, Copy, Trash, Plus, Sun, Moon, GraduationCap, Coffee, MoreHorizontal, Mail, Info, Settings, User, Users, Music, Image, ExternalLink, Palette, Package, Lightbulb, Send, Sparkles, MapPin, Search, ZoomIn, Star, Home, Calendar, LogOut, LogIn, Shield, Clock, KeyRound, AlertCircle, Pencil, Lock } from 'lucide-react';
...
export const TeaLeafIcon = ({ className, filled, style, ...props }: { className?: string, filled?: boolean, style?: React.CSSProperties } & React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    />
    <path d="M12 20.5V8" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
    <path d="M12 8L8 5" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
    <path d="M12 8L16 5" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
  </svg>
);
...
export const OfferingsIcon = ({ className, filled, style, ...props }: { className?: string, filled?: boolean, style?: React.CSSProperties } & React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <g>
      ...
      <path d="M12.4 12.5h5.2" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
      <path d="M14 6.5c0.6-0.5 0.6-1.3 0-1.8" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
      <path d="M16 6.5c0.6-0.5 0.6-1.3 0-1.8" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
...
export const LearnIcon = ({ className, filled, style, ...props }: { className?: string, filled?: boolean, style?: React.CSSProperties } & React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <g>
      ...
      <path d="M8 5.5V17.5" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
      <path d="M12.5 9.5c1.1 0 2 .9 2 2 0 1.6-1.15 2.9-3.2 3.6" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
      <path d="M12.5 9.5c-0.7 0.4-1.4 1.2-1.7 2.3" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
    </g>
  </svg>
);
...
export const ShopIcon = ({ className, filled, style, ...props }: { className?: string, filled?: boolean, style?: React.CSSProperties } & React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={className} style={style} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <g>
      ...
      <path d="M10 7.6h4" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
      ...
      <path d="M8.7 12.1h6.6" stroke={filled ? "var(--tea-text-sec)" : "currentColor"} />
    </g>
  </svg>
);
