    ...
    <div className="w-full">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs text-tea-gold font-medium">Portfolio</span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {displayedProjects.map((project) => (
          <button
            ...
            className="group text-left bg-tea-bg rounded-xl overflow-hidden border border-tea-border hover:border-tea-gold/30 transition-all duration-300"
          >
            {/* Image */}
      ...
      {selectedProject && (
        <div
          className="fixed inset-0 z-modal bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 md:p-6 animate-[fadeIn_0.2s_ease-out]"
          onClick={closeModal}
        >
          <div
