...
export const Card: React.FC<CardProps> = ({ story, onClick, isSaved, isWatched, onToggleSave, onShare }) => {
  ...
  return (
    <div
      ref={parallaxRef}
      className={`cursor-pointer group relative transition-colors duration-300 ${watchedStyle}`}
              ...
              <div className="absolute inset-0 flex flex-col bg-tea-elevated/90">
                ...
                {isAudio ? (
                   <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-6 text-center">
                       <div className="w-16 h-16 rounded-full border border-tea-border flex items-center justify-center mb-5 relative transition-colors duration-700">
                       ...
                       <span className="text-ui-9 font-mono tabular-nums text-tea-text-sec">{story.durationOrTime}</span>
                   </div>
                ) : (
              ...
              <>
               ...
               {isAudio && (
                 <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
                    <div className="w-12 h-12 rounded-full bg-tea-gold/10 backdrop-blur-md border border-tea-border flex items-center justify-center opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 shadow-lg">
               ...
               {isVideo && (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-10 h-10 rounded-full border-[0.5px] border-tea-border flex items-center justify-center backdrop-blur-none group-hover:backdrop-blur-[1px] group-hover:bg-tea-gold/5 transition-all duration-700">
