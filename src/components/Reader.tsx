    ...
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        <div
          ...
          className="tap-target flex-1 !justify-stretch cursor-pointer group relative select-none"
          role="slider"
            ...
            <div key={s.id} onClick={() => { onNavigate(s); setShowNav(false); }} className="group cursor-pointer flex gap-5">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <span className="text-ui-11 uppercase tracking-caps text-tea-text-dim mb-1 block">{s.type}</span>
          ...
          >
            ...
            <div className="space-y-1">
              {chapters.map((ch, i) => (
                ...
                >
                  <span className="text-tea-text-dim text-ui-10 uppercase tracking-caps mr-3">{String(i + 1).padStart(2, '0')}</span>
      ...
      {showKeyboardHints && (
        ...
        >
          <div className="reader-keyboard-hint-card">
            <div className="text-ui-10 uppercase tracking-caps text-tea-text-dim mb-4">Keyboard Shortcuts</div>
            {[
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-16 z-50 flex items-center justify-between px-6 md:px-10 text-tea-text-sec pointer-events-none bg-gradient-to-b from-tea-bg/40 to-transparent">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-xs uppercase tracking-caps text-tea-text-sec hover:text-tea-text pointer-events-auto transition-colors p-3 -ml-3 rounded-full"
        >
      ...
      <div className="relative flex-1 flex flex-col overflow-hidden w-full h-full">
        ...
        >
          ...
          >
            <span className="text-ui-11 uppercase tracking-display text-tea-text-dim" style={{ fontFamily: 'var(--font-sans)' }}>
              {story.title}
            </span>
          </div>
