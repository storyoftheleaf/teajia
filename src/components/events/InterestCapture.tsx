    ...
    <div className={className}>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-tea-gold text-tea-bg text-xs rounded-sm hover:bg-tea-gold/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
        >
          {mutation.isPending ? (
