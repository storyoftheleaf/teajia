          ...
          {step === 'contact' && (
            <>
              ...
              <button
                ...
                className="w-full py-3.5 bg-tea-gold text-tea-bg text-xs uppercase tracking-display rounded-sm hover:bg-tea-gold/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center"
              >
