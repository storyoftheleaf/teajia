    ...
    <div className="px-4 py-3 space-y-3">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="w-full pl-6 pr-2 py-2 bg-transparent border-b border-tea-text/10 focus:border-tea-gold outline-none font-serif italic text-sm text-tea-text placeholder:text-tea-text/30 dark:placeholder:text-tea-bg/30 transition-colors"
        />
      </div>
