          ...
          <div className="px-1 mt-3">
            ...
            <div className="mt-3">
              <button
                ...
                className="bg-tea-gold hover:bg-tea-gold/90 text-tea-bg text-xs uppercase tracking-[0.15em] font-medium py-2 px-4 rounded-xl transition-all active:scale-95 flex items-center justify-center gap-3 w-full"
              >
