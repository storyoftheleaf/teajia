...
export const ForYourPractice: React.FC<ForYourPracticeProps> = ({
  ...
  const renderSetCard = (set: StarterSet) => {
    ...
    return (
      ...
      >
        <div className="p-2 md:p-3 bg-tea-elevated border border-tea-border rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.3)]">
          ...
          <ShopGridLayout>
            {INCENSE_ITEMS.map(item => (
              <CardGridItem
                ...
                priceDisplay={<span className="card-grid-price">${parseFloat(item.price_50g || '0')}</span>}
