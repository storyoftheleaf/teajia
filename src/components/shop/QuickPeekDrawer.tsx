...
export const QuickPeekDrawer: React.FC<QuickPeekDrawerProps> = ({ item, onClose, onAddToCart }) => {
  ...
  // Fixed max — don't reveal exact stock to customers. Validated at cart time.
  const maxQty = isTea ? 1000 : 20;
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-center pt-3 pb-1 lg:hidden">
          <div className="w-10 h-1 rounded-full bg-tea-text/20" />
        </div>
        ...
        <div className="sticky top-0 bg-tea-bg px-6 py-4 flex items-center justify-between z-10" style={{ boxShadow: '0 1px 0 var(--tea-border)' }}>
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-md hover:bg-tea-text/10 min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0"
          >
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Meta */}
          <div>
            <p className="text-xs uppercase tracking-wider text-tea-text/50 mb-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs uppercase tracking-wider text-tea-text/50">
                Quantity
              </span>
