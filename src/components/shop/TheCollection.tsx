      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6 md:p-8 flex flex-col">
          <div className="flex items-start justify-between gap-3 mb-3">
            <h3 className="font-serif text-2xl text-tea-paper">{item.name}</h3>
            <ShippingBadge type={item.shippingType} />
          </div>

          <p className="font-serif text-tea-paper/60 italic mb-4">{item.subtitle}</p>

          <p className="text-sm text-tea-paper/70 leading-relaxed mb-6 flex-1">
            {item.story}
          </p>

          {/* Meta details */}
          <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-tea-paper/40 uppercase tracking-wider mb-6">
  ...
  return (
    <div className="w-full bg-tea-bg text-tea-paper min-h-screen animate-[fadeIn_0.5s_ease-out]">
      <PageHeader
        ...
        backLabel="Shop"
        rightContent={
          <span className="text-[10px] uppercase tracking-[0.2em] text-tea-paper/30">
            By inquiry only
          </span>
        }
      />
      ...
      <div className="px-6 md:px-10 py-16 md:py-24 max-w-4xl mx-auto">
        <p className="text-lg text-tea-paper/60 max-w-xl leading-relaxed">
