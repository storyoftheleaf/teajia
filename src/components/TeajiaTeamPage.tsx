    ...
    <div className="w-full animate-[fadeIn_0.6s_ease-out]">
      ...
      <div className="bg-gradient-to-b from-tea-seal/10 dark:from-tea-seal/5 to-transparent py-16 px-4 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-serif text-4xl md:text-5xl text-tea-ink dark:text-tea-paper mb-4">
            The Teajia Family
          </h1>
          <p className="text-lg text-tea-ink/70 dark:text-tea-paper/70">
      ...
      <div className="max-w-5xl mx-auto px-4 mb-16">
        <div className="bg-tea-paper dark:bg-white/5 rounded-lg p-8 md:p-12 border border-tea-seal/20">
          <h2 className="font-serif text-2xl text-tea-ink dark:text-tea-paper mb-4">Our Mission</h2>
          <p className="text-tea-ink/80 dark:text-tea-paper/80 text-lg leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-4 mb-24">
        <h2 className="font-serif text-3xl text-tea-ink dark:text-tea-paper mb-12 text-center">
          Meet Our Team
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member) => (
            ...
            >
              {/* Photo */}
              <div className="mb-6 relative overflow-hidden rounded-lg bg-tea-ink/5 dark:bg-white/5 aspect-square flex items-center justify-center">
                {member.photo ? (
                  <img
                    src={member.photo}
                    alt={member.name}
                  ...
                  <Icons.User className="w-24 h-24 text-tea-ink/20 dark:text-tea-paper/20" />
                )}
              </div>

              {/* Info */}
              <h3 className="font-serif text-xl text-tea-ink dark:text-tea-paper mb-1">
                {member.name}
              </h3>
              <p className="text-sm uppercase tracking-widest text-tea-seal mb-3">
                {member.role}
              </p>
              <p className="text-tea-ink/70 dark:text-tea-paper/70 text-sm leading-relaxed mb-4">
                {member.bio}
              </p>
                ...
                <div className="flex justify-center gap-3">
                  {member.socialLinks.instagram && (
                    <a
                      ...
                      className="p-2 rounded-full hover:bg-tea-seal/8 dark:hover:bg-tea-seal/15 text-tea-ink/60 dark:text-tea-paper/60 hover:text-tea-seal transition-all"
                      title="Instagram"
                    >
      ...
      {/* Values Section */}
      <div className="bg-tea-seal/5 dark:bg-tea-seal/5 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-tea-seal/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icons.Leaf className="w-6 h-6 text-tea-seal" />
              </div>
              <h3 className="font-serif text-xl text-tea-ink dark:text-tea-paper mb-2">
                Community First
              </h3>
              <p className="text-tea-ink/70 dark:text-tea-paper/70">
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-tea-seal/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icons.Palette className="w-6 h-6 text-tea-seal" />
              </div>
              <h3 className="font-serif text-xl text-tea-ink dark:text-tea-paper mb-2">
                Authenticity
              </h3>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-tea-seal/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icons.Lightbulb className="w-6 h-6 text-tea-seal" />
              </div>
              <h3 className="font-serif text-xl text-tea-ink dark:text-tea-paper mb-2">
                Mindfulness
              </h3>
