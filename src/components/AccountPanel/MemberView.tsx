...
export const MemberView: React.FC<MemberViewProps> = ({
  ...
  return (
    <div>
      ...
      <div className="px-6 pt-7 pb-[calc(52px+env(safe-area-inset-bottom,0px))] lg:pb-8 border-t border-tea-border mt-3">
        <div
          className="flex flex-wrap items-center gap-x-3 gap-y-1 text-ui-12 text-tea-text-sec tracking-[0.03em]"
        >
          <button
