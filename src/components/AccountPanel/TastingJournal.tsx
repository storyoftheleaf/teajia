            ...
            <div key={group.eventId || `solo-${gi}`}>
              ...
              {group.eventId && group.entries.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 mb-1.5 mt-3 first:mt-0 px-1 group w-full text-left"
                >
                  <Calendar size={12} className="text-tea-gold shrink-0" />
                  <span
                    className="text-[11px] font-medium text-tea-gold group-hover:text-tea-gold-lt transition-colors truncate"
                  ...
                  <div className="flex-1 border-b border-tea-border/40 ml-1" />
                </button>
              )}

              {/* Entries in this group */}
              <div className={`space-y-2 ${group.eventId ? 'ml-1 pl-3 border-l border-tea-gold/15' : ''}`}>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                              ...
                              {/* Event context badge — clickable link */}
                              {entry.eventId && (
                                <button
                                  onClick={(e) => { e.stopPropagation(); navigate(`/events/${entry.eventId}`); }}
                                  className="badge-status badge-status-gold hover:opacity-80 transition-opacity cursor-pointer"
                                >
                                  <Calendar size={9} />
