...
export const BottomTabBar: React.FC<BottomTabBarProps> = ({
  ...
  return (
    <>
      ...
      <nav
        className={`flex lg:hidden fixed bottom-0 left-0 right-0 bg-tea-surface/92 backdrop-blur-xl border-t border-tea-border/50 z-[65] animate-[slideUp_0.4s_ease-out] transition-all duration-200 pb-[env(safe-area-inset-bottom)] ${
