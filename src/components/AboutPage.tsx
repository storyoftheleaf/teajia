    ...
    <div className="animate-[fadeIn_0.6s_ease-out] pb-24 md:pb-24">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <header className="pt-12 mb-12">
          ...
          <div className="w-12 h-[1px] bg-tea-seal"></div>
        </header>

        {/* Photo placeholder */}
        <div className="aspect-[4/3] bg-tea-ink/5 dark:bg-white/5 rounded-lg mb-12 flex items-center justify-center">
          <span className="text-sm text-tea-ink/30 dark:text-tea-paper/30 uppercase tracking-widest">
            Photo
          </span>
        </div>
        ...
        <section className="mb-16">
          <div className="font-serif text-lg md:text-xl leading-relaxed text-tea-ink dark:text-tea-paper space-y-6">
            <p>
        ...
        {/* Your Story section */}
        <section className="mb-16">
          <h2 className="font-serif text-2xl md:text-3xl text-tea-ink dark:text-tea-paper mb-6">
            The Story
          </h2>
          <div className="w-12 h-[1px] bg-tea-seal mb-6"></div>
        ...
        {/* Art Studio link */}
        <section className="py-12 border-t border-tea-ink/10 dark:border-white/10">
          <p className="text-tea-ink/70 dark:text-tea-paper/70 mb-4">
            Adrian is also a visual artist creating laser-cut work, oracle cards, and more.
          </p>
          <a
            href="#"
            className="text-tea-seal hover:text-tea-seal/80 transition-colors duration-300 uppercase tracking-wider text-xs font-medium inline-flex items-center gap-2"
          >
