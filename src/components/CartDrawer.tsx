        ...
        <div className="flex-1 overflow-y-auto p-6 relative">
           ...
           {removedItem && (
               <div className="relative z-20 mb-4 animate-[slideUp_0.3s_ease-out]">
                   <div className="flex items-center justify-between bg-tea-bg text-tea-bg  px-4 py-3 rounded-sm">
            ...
            {step === 'CART' && (
                <div className="flex flex-col gap-4">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-tea-gold text-tea-bg uppercase tracking-[0.2em] text-xs hover:bg-tea-gold/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        Request This Order
                    </button>
                </div>
