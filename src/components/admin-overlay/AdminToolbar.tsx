...
export const AdminToolbar: React.FC<AdminToolbarProps> = ({ collapsed: controlledCollapsed, onCollapsedChange }) => {
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="fixed top-2 right-2 z-modal w-8 h-8 rounded-full bg-tea-bg/80 dark:bg-white/10 backdrop-blur-sm flex items-center justify-center text-tea-text/60 hover:text-tea-text transition-colors shadow-lg"
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-sticky bg-tea-bg/90 dark:bg-[#1a1a1a]/95 backdrop-blur-md border-b border-tea-border h-9 flex items-center px-3 lg:pl-24 xl:pl-60 shadow-lg">
      {/* Stats */}
