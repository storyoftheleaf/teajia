    ...
    <>
      ...
      >
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <p className="text-ui-10 uppercase tracking-caps text-tea-text/50 mb-3">
                      {story.author.role}
                    </p>
                  </button>
                  {story.author.bio && (
        ...
        <div className="px-5 md:px-8 lg:px-12 pb-16">
          <button
            onClick={handleShareFeature}
            className="w-full max-w-sm mx-auto py-4 min-h-[56px] bg-tea-elevated text-tea-text font-medium text-sm uppercase tracking-caps rounded-full shadow-md active:scale-[0.98] active:shadow-sm transition-all flex items-center justify-center gap-3"
          >
