      ...
      <div className="bg-tea-surface rounded-lg p-3 space-y-3">
        ...
        <div className="rounded-lg space-y-3">
          ...
          <input
            ...
            className="w-full bg-tea-surface/60 text-tea-text text-lg rounded-md px-3 py-1.5 border border-tea-border/30 focus:border-tea-gold/50 outline-none transition-colors placeholder:text-tea-text-dim"
          />
        </div>
        ...
        <div className="rounded-lg space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-tea-surface/60 text-tea-text rounded-md px-3 py-1.5 border border-tea-border/30 focus:border-tea-gold/50 outline-none transition-colors text-base tabular-nums"
          />
      ...
      <div className="rounded-lg space-y-3">
        ...
        <div className="flex items-center gap-2">
          <AutocompleteInput
            ...
            className="w-full bg-tea-surface/60 text-tea-text text-lg rounded-md px-3 py-1.5 border border-tea-border/30 focus:border-tea-gold/50 outline-none transition-colors min-w-0 placeholder:text-tea-text-sec/50"
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-24 bg-tea-surface/60 text-tea-text rounded-md px-3 py-1.5 border border-tea-border/30 focus:border-tea-gold/50 outline-none transition-colors text-sm tabular-nums"
                />
              </div>
