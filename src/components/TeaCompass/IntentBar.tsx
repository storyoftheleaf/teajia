...
export const IntentBar: React.FC<IntentBarProps> = ({ entry, onApply }) => {
  ...
  return (
    <div className="flex items-center gap-2 px-1 flex-wrap">
      ...
      <span className="text-[10px] text-tea-text-dim shrink-0">Detected:</span>
        ...
        return (
          <span key={key} className="flex items-center gap-0.5">
            <button
              ...
              className="text-[10px] text-tea-gold/80 hover:text-tea-gold underline underline-offset-2 decoration-dashed transition-colors"
            >
              {intent.label}
            </button>
            <button
