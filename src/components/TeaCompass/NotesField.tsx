    ...
    <div className="space-y-1">
            ...
            <div key={i}>
              {editingIndex === i ? (
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-tea-gold/[0.06] text-tea-text rounded-md px-3 py-2 border border-tea-gold/10 focus:border-tea-gold/40 outline-none focus-visible:ring-2 focus-visible:ring-tea-gold/50 focus-visible:ring-offset-1 focus-visible:ring-offset-tea-bg transition-colors text-base resize-none"
                />
              ) : (
                <div
                  onClick={() => startEdit(i)}
      ...
      <div className="flex gap-2 items-end">
        <textarea
          ...
          rows={focused ? 5 : 3}
          className="flex-1 bg-tea-gold/[0.06] text-tea-text rounded-md px-3 py-2 border border-tea-gold/10 focus:border-tea-gold/40 outline-none focus-visible:ring-2 focus-visible:ring-tea-gold/50 focus-visible:ring-offset-1 focus-visible:ring-offset-tea-bg transition-colors text-base resize-none"
        />
        {currentInput.trim() && (
          <button
            type="button"
