    ...
    <div className="space-y-1">
            ...
            <div key={i}>
              {editingIndex === i ? (
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-tea-surface/60 text-tea-text rounded-md px-3 py-2 border border-tea-border focus:border-tea-gold/50 outline-none transition-colors text-base resize-none"
                />
              ) : (
                <div
                  onClick={() => startEdit(i)}
      ...
      <div className="flex gap-2 items-end">
        <textarea
          ...
          rows={focused ? 5 : 3}
          className="flex-1 bg-tea-surface/60 text-tea-text rounded-md px-3 py-2 border border-tea-border focus:border-tea-gold/50 outline-none transition-colors text-base resize-none"
        />
        {currentInput.trim() && (
          <button
            type="button"
