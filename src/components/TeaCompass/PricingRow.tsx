...
export const PricingRow: React.FC<PricingRowProps> = ({
  ...
  const inputShellClass = 'bg-tea-bg rounded-md border border-tea-border focus-within:border-tea-gold/40';
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-stretch gap-2">
        ...
        {unit.mode === 'grams' ? (
          ...
          <div
            className="shrink-0 flex items-stretch bg-tea-bg rounded-md border border-tea-border"
