      ...
      <div className="flex gap-4 items-end">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              className="flex-1 min-w-0 bg-tea-surface/60 text-tea-text rounded-md px-3 py-1.5 border border-tea-border/10 focus:border-tea-gold/50 outline-none transition-colors text-base tabular-nums
        ...
        <div className="flex-1 min-w-0">
          ...
          <input
            ...
            style={noSpinnerStyle}
            className="w-full bg-tea-surface/60 text-tea-text rounded-md px-3 py-1.5 border border-tea-border/10 focus:border-tea-gold/50 outline-none transition-colors text-base tabular-nums text-right
                       placeholder:text-tea-text-sec/50 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          />
        </div>
      </div>
