                  ...
                  {groupedItems.map((group) => (
                      <React.Fragment key={group.id}>
                          ...
                          {group.items.map((item) => {
                              ...
                              return (
                                  <div key={item.id} className={`relative border-b border-tea-border transition-colors duration-300 ${isExpanded ? 'bg-tea-text/5' : 'hover:bg-tea-elevated/50'}`}>
                                          ...
                                          <div className="flex-1 min-w-0 flex items-center justify-between">
                                              <div className="flex flex-col justify-center">
                                                  <div className="flex items-center gap-2">
                                                      <h3 className={`font-serif text-lg md:text-xl leading-none transition-colors ${isExpanded ? 'text-tea-gold' : 'text-tea-text group-hover:text-tea-text/90 dark:group-hover:text-tea-bg/90'}`}>{item.name}</h3>
                                                  </div>
