    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 bg-tea-text/5 rounded-lg text-sm text-tea-text placeholder:text-tea-text/30 dark:placeholder:text-tea-paper/30 outline-none focus:ring-2 focus:ring-tea-gold/30 transition-shadow"
        />
        {query && (
          <button
            onClick={() => setQuery('')}
