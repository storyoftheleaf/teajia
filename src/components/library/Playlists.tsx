      ...
      <div className="flex flex-col divide-y divide-tea-ink/5 dark:divide-white/5">
        {PLAYLISTS.map(item => (
          <a
            ...
            className="flex items-start gap-4 py-4 px-1 group hover:bg-tea-ink/[0.02] dark:hover:bg-white/[0.02] transition-colors"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <h3 className="font-serif text-sm text-tea-ink dark:text-tea-paper truncate">
                  {item.title}
                </h3>
