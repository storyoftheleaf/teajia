    ...
    <div className="w-full">
      ...
      <div className="flex flex-col divide-y divide-tea-gold/[0.06]">
        {PLAYLISTS.map(item => (
          ...
          >
            <div className="w-9 h-9 rounded-sm flex items-center justify-center shrink-0 mt-0.5 bg-tea-readgold/10 dark:bg-tea-readgold/20 text-tea-readgold dark:text-tea-readgold">
