        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 mb-10">
          ...
          <div className="flex gap-12 sm:gap-16">
            <div className="flex flex-col gap-2.5">
              <span className="text-ui-10 uppercase tracking-display text-tea-gold/70 font-sans font-semibold mb-1">Explore</span>
            ...
            <div className="flex flex-col gap-2.5">
              <span className="text-ui-10 uppercase tracking-display text-tea-gold/70 font-sans font-semibold mb-1">Connect</span>
              <a
