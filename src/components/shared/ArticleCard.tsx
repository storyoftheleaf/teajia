  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center py-4 pl-5 pr-4 min-w-0">
        ...
        {description && (
          <p className="text-ui-11 text-tea-text-sec font-sans leading-normal line-clamp-1">
            {description}
          </p>
        )}
        {authorName && (
          <button
            ...
            className="mt-1 text-ui-10 uppercase tracking-caps text-tea-text-dim hover:text-tea-gold transition-colors font-sans text-left"
          >
            {authorName}
          </button>
        )}
      ...
      <div className="shrink-0 w-[88px] self-stretch">
        {hasImage ? (
          ...
          <div className="w-full h-full bg-tea-elevated/40 flex items-center justify-center">
            <p className="text-ui-8 uppercase tracking-display text-tea-text-dim font-sans rotate-90 whitespace-nowrap">
