    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          role="status"
          aria-live="polite"
          className="fixed bottom-[calc(49px+env(safe-area-inset-bottom,0px)+1rem)] lg:bottom-8 left-1/2 lg:left-auto lg:right-8 lg:translate-x-0 -translate-x-1/2 z-toast pointer-events-none"
