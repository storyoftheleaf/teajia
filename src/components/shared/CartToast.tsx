        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[11px] text-tea-text-sec uppercase tracking-[0.15em] mb-0.5">Added to cart</p>
            ...
            <button
              ...
              className="shrink-0 flex items-center gap-1.5 px-2 py-1.5 text-tea-text text-[11px] uppercase tracking-[0.15em] underline underline-offset-4 decoration-tea-border hover:decoration-tea-gold transition-colors"
            >
