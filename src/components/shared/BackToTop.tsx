    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-[calc(49px+env(safe-area-inset-bottom,0px)+1.5rem)] lg:bottom-8 right-4 lg:right-6 z-40 flex flex-col items-center gap-1 group cursor-pointer bg-transparent border-none p-2"
