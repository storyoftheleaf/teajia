    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-nav-gap lg:bottom-8 right-4 lg:right-6 z-40 flex flex-col items-center gap-1 group cursor-pointer bg-transparent border-none p-2"
