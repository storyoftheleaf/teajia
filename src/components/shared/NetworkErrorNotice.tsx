  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <svg className="w-4 h-4 text-tea-text-dim shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
