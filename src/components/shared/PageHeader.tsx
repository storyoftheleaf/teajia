                ...
                <div className="flex items-center gap-1.5 lg:hidden">
                  ...
                  {onCartClick && (
                    ...
                    >
                      ...
                      {cartItemCount > 0 && (
                        <div className={`absolute -top-0.5 -right-0.5 w-4 h-4 bg-tea-gold text-tea-bg text-[9px] font-bold rounded-full flex items-center justify-center ${badgeAnimating ? 'cart-badge-pulse' : ''}`}>
