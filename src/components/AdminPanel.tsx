            ...
            <div className="flex-1 flex overflow-hidden relative">
                ...
                {tab === 'CANVAS' && !isMedia && (
                    <div className="hidden md:flex w-28 bg-tea-bg border-r border-tea-border flex-col overflow-y-auto hide-scrollbar py-4 gap-4 items-center shrink-0 z-10">
                        ...
                        <button onClick={addPage} className="w-20 h-10 border border-dashed border-tea-border flex items-center justify-center text-tea-text-sec hover:text-white hover:border-tea-gold/20"><Icons.Plus className="w-4 h-4" /></button>
                    </div>
                )}
