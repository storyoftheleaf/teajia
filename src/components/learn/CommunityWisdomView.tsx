...
export const CommunityWisdomView: React.FC<CommunityWisdomViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="w-full pb-32 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="mb-6">
        <h2 className="font-serif text-xl text-tea-ink dark:text-tea-paper mb-1">Community Wisdom</h2>
        <p className="text-sm text-tea-ink/50 dark:text-tea-paper/50 font-serif italic">Reflections, tips, and rituals from tea lovers</p>
      </div>
