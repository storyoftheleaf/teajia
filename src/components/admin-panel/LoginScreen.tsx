                ...
                {!createdKey ? (
                    <>
                        <input
                            ...
                            placeholder="Passkey"
                            className="w-full bg-tea-surface border border-tea-border p-3 text-center text-tea-text tracking-display outline-none focus-visible:ring-2 focus-visible:ring-tea-gold/50 focus-visible:ring-offset-1 focus-visible:ring-offset-tea-bg focus:border-tea-gold rounded-sm mb-4 placeholder:text-tea-text/30"
                        />
                        <button onClick={checkLogin} className="w-full bg-tea-gold text-tea-bg py-3 uppercase tracking-caps text-xs font-bold hover:bg-tea-gold-lt transition-colors rounded-sm mb-6">Enter</button>
                        ...
                        <div className="border-t border-tea-border pt-6">
                            ...
                            <button
                                ...
                                className="text-tea-gold text-xs uppercase tracking-caps hover:text-tea-text transition-colors border border-tea-border px-4 py-2 rounded-sm hover:bg-tea-gold/10"
                            >
                                Generate New Key
                            </button>
                        </div>
                    ...
                    <div className="bg-tea-surface border border-tea-border p-6 rounded-sm animate-[fadeIn_0.3s_ease-out]">
                        ...
                        <p className="text-xs uppercase tracking-caps text-tea-text/80 mb-1">Your Key</p>
                        <div className="bg-tea-bg border border-tea-border p-3 mb-4 select-all cursor-text">
                            <span className="text-tea-text font-mono text-lg tracking-caps">{createdKey}</span>
                        </div>
                        <button
                            onClick={() => { setPwd(createdKey); setCreatedKey(null); }}
                            className="w-full bg-tea-gold text-tea-bg py-3 uppercase tracking-caps text-xs font-bold hover:bg-tea-gold-lt transition-colors rounded-sm"
                        >
                            Login Now
                        </button>
                    </div>
