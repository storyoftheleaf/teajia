            ...
            <div className="w-full max-w-xs text-center">
                ...
                {!createdKey ? (
                    <>
                        ...
                        <div className="border-t border-tea-border pt-6">
                            ...
                            <button
                                ...
                                className="text-tea-gold text-xs uppercase tracking-[0.15em] hover:text-tea-text transition-colors border border-tea-gold/30 px-4 py-2 rounded-sm hover:bg-tea-gold/10"
                            >
                                Generate New Key
                            </button>
                        </div>
                    ...
                    <div className="bg-tea-surface border border-tea-gold/40 p-6 rounded-sm animate-[fadeIn_0.3s_ease-out]">
                        ...
                        <div className="bg-tea-bg border border-tea-gold/15 p-3 mb-4 select-all cursor-text">
