    ...
    return (
        <div className="w-full h-full bg-tea-bg flex items-center justify-center p-6 md:pb-6">
            ...
            <div className="w-full max-w-xs text-center">
                <div className="w-12 h-12 bg-tea-gold rounded-lg mx-auto mb-8 flex items-center justify-center text-black font-serif font-bold text-xl">T</div>
                    ...
                    <>
                        ...
                        <div className="border-t border-tea-gold/15 pt-6">
                            ...
                            <button
                                ...
                                className="text-tea-gold text-xs uppercase tracking-[0.15em] hover:text-white transition-colors border border-tea-gold/30 px-4 py-2 rounded-sm hover:bg-tea-gold/10"
                            >
                                Generate New Key
                            </button>
                        </div>
