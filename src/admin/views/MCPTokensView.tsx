    ...
    <div className="px-4 md:px-6 pt-6 pb-nav-gap max-w-3xl mx-auto">
      <header className="mb-10">
        ...
        <p className="text-tea-text-sec text-ui-14 leading-[1.6] max-w-xl mt-4">
          ...
          i64os access. Tools cover tea search, stock adjustments, customer lookup, and
          creating filled invoices — every mutating action requires a spoken confirmation
          in the model. The token grants owner-level commerce rights on this account;
