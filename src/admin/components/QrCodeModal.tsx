    ...
    <div className="fixed inset-0 z-modal flex items-center justify-center p-4 print:bg-white print:p-0">
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div className="text-ui-12 text-tea-text-dim text-center print:text-black mt-3">
            ID: {product.id}
          </div>
        </div>

        <div className="flex justify-between gap-2 px-5 py-3 border-t border-tea-border bg-tea-bg/40 rounded-b-xl print:hidden">
          <button
            type="button"
            onClick={onClose}
