    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto px-6 py-6">
        <div className="max-w-xl mx-auto space-y-8">
          ...
          <div>
            <span className="block text-ui-11 uppercase tracking-[0.14em] text-tea-text-sec mb-3">
              Teas
            </span>
      ...
      <footer className="px-6 py-4 border-t border-tea-border flex items-center justify-between">
        <button
          type="button"
          onClick={() => navigate('/admin/tasting-events')}
          className="text-tea-text-sec hover:text-tea-text text-ui-13"
        >
          Cancel
        </button>
        <button
          ...
          onClick={create}
          className="rounded-full bg-tea-gold text-tea-bg px-6 py-2 text-ui-13 tracking-wide disabled:opacity-40"
        >
