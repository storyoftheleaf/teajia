...
export const PostSessionEditor: React.FC<PostSessionEditorProps> = ({ eventId }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Tea Ledger */}
      <div>
        <label className="text-ui-10 uppercase tracking-display text-tea-text-sec block mb-2 flex items-center gap-1.5">
      ...
      {/* Session Notes */}
      <div>
        <label className="text-ui-10 uppercase tracking-display text-tea-text-sec block mb-2">Session Notes</label>
        <textarea
          value={sessionNotes}
      ...
      {tastingNotes.length > 0 && (
        <div className="pt-4 border-t border-tea-border">
          <h3 className="text-ui-10 uppercase tracking-display text-tea-text-sec mb-3 flex items-center gap-1.5">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-tea-border">
                  <th className="text-left text-ui-10 uppercase tracking-caps text-tea-text-sec font-medium py-2 px-2">Guest</th>
                  <th className="text-left text-ui-10 uppercase tracking-caps text-tea-text-sec font-medium py-2 px-2">Tea</th>
                  <th className="text-left text-ui-10 uppercase tracking-caps text-tea-text-sec font-medium py-2 px-2">Rating</th>
                  <th className="text-left text-ui-10 uppercase tracking-caps text-tea-text-sec font-medium py-2 px-2">Impression</th>
                </tr>
              </thead>
              <tbody>
