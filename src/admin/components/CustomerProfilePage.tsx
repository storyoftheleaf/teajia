        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 py-8 space-y-8">
          ...
          {lastEvent && (
            <div className="bg-tea-surface border border-tea-border rounded-xl p-5">
              <p className="text-ui-10 uppercase tracking-caps text-tea-text-sec mb-3">Last session</p>
          ...
          {customer.notes && (
            <div>
              <p className="text-ui-10 uppercase tracking-caps text-tea-text-sec mb-2">Notes</p>
