      ...
      {selectedCount > 0 && isEditMode && (
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-tea-gold text-tea-bg text-ui-10 font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-tea-gold/90 transition-colors disabled:opacity-40"
          >
