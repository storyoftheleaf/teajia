          ...
          <div className="bg-tea-bg border border-tea-border rounded-xl max-w-sm w-full p-6 shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="enrich-confirm-title">
            ...
            <div className="flex justify-between items-center gap-3 pt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-tea-gold text-tea-bg text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-tea-gold/90 disabled:opacity-40 transition-colors"
              >
          ...
          <div className="bg-tea-bg border border-tea-border rounded-xl max-w-sm w-full p-6 shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="verification-reset-title">
            ...
            <div className="flex justify-between items-center gap-3 pt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-tea-gold text-tea-bg text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-tea-gold/90 transition-colors"
              >
                Reset
              </button>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="flex gap-3 w-full pt-4">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-tea-gold/20 border border-tea-accent-sub text-tea-gold text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-tea-gold/30 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                >
          ...
          <div className="bg-tea-bg border border-tea-border w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]" role="dialog" aria-modal="true" aria-labelledby="inventory-maintenance-title">
            ...
            <div className="p-4 border-t border-tea-border flex justify-end bg-tea-surface">
              <button
                ...
                className="px-6 py-2 bg-tea-gold text-tea-bg text-xs font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-tea-gold/90 transition-colors"
              >
                Close
              </button>
            </div>
