...
export const VIEW_FILTER_LABELS: Record<string, string> = {
  ...
  NeedsWriting: 'Needs writing',
  HasProductTasting: 'Has tasting profile',
  NeedsProductTasting: 'Needs tasting profile',
...
export const DEFAULT_TEA_VIEWS: InventoryViewConfig[] = [
  ...
  {
    id: 'default-needs-writing',
    name: 'Needs writing',
    icon: 'AlertTriangle',
    columns: ['productName', 'type', 'year', 'originRegion', 'stockGrams', 'vendor'],
    sortConfig: [{ key: 'type', direction: 'asc' }],
    filterType: 'NeedsWriting',
    groupBy: null,
  },
  {
    id: 'default-has-writing',
    name: 'Has writing',
    icon: 'CheckSquare',
    columns: ['productName', 'type', 'year', 'originRegion', 'stockGrams', 'vendor'],
    sortConfig: [{ key: 'type', direction: 'asc' }],
    filterType: 'HasWriting',
    groupBy: null,
  },
  {
    id: 'default-needs-tasting-profile',
    name: 'Needs tasting profile',
    icon: 'FlaskConical',
    columns: ['productName', 'type', 'year', 'originRegion', 'stockGrams', 'vendor'],
    sortConfig: [{ key: 'type', direction: 'asc' }],
    filterType: 'NeedsProductTasting',
    groupBy: null,
  },
  {
    id: 'default-archived',
...
export const DEFAULT_TEAWARE_VIEWS: InventoryViewConfig[] = [
  ...
  {
    id: 'default-teaware-working',
    name: 'Working',
    icon: 'Globe',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits', 'costAmount', 'pricePerGramUSD'],
    sortConfig: [{ key: 'teawareCategory', direction: 'asc' }],
    filterType: 'Working',
    groupBy: null,
  },
  {
    id: 'default-teaware-samples',
    name: 'Samples',
    icon: 'FlaskConical',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits', 'costAmount'],
    sortConfig: [{ key: 'teawareCategory', direction: 'asc' }],
    filterType: 'Samples',
    groupBy: null,
  },
  {
    id: 'default-teaware-personal',
    name: 'Personal',
    icon: 'Coffee',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits', 'costAmount'],
    sortConfig: [{ key: 'teawareCategory', direction: 'asc' }],
  ...
  {
    id: 'default-teaware-reorder',
    name: 'Reorder',
    icon: 'PackageX',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits', 'costAmount'],
    sortConfig: [{ key: 'quantityUnits', direction: 'asc' }],
    filterType: 'Reorder',
    groupBy: null,
  },
  {
    id: 'default-teaware-low-stock',
    name: 'Low stock',
    icon: 'AlertTriangle',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits'],
    sortConfig: [{ key: 'quantityUnits', direction: 'asc' }],
    filterType: 'LowStock',
    groupBy: null,
  },
  {
    id: 'default-teaware-missing-location',
    name: 'Missing location',
    icon: 'Archive',
    columns: ['productName', 'teawareCategory', 'material', 'quantityUnits'],
    sortConfig: [{ key: 'teawareCategory', direction: 'asc' }],
