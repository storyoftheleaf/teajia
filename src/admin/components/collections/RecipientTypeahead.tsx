      ...
      <div className="rounded-xl border border-tea-border bg-tea-bg/40 overflow-visible">
        ...
        <div className="relative">
          ...
          {open && (matches.length > 0 || queryIsNewName) && (
            <ul className="absolute top-full left-0 right-0 mt-1 z-30 max-h-64 overflow-y-auto rounded-lg bg-tea-surface border border-tea-border shadow-2xl py-1">
              {matches.map(c => (
                <li key={c.id}>
                  <button
                    type="button"
            ...
            {tags.length > 0 && (
              <div className="relative flex items-start gap-2">
                ...
                {tagsExpanded && (
                  <div
                    ref={tagPopoverRef}
                    className="absolute z-40 top-full mt-1 left-16 w-[280px] max-w-[calc(100%-4rem)] rounded-lg bg-tea-surface border border-tea-border shadow-2xl"
                  >
                ...
                return (
                  ...
                  >
                    ...
                    {editing && (
                      <div
                        ref={tagEditorRef}
                        className="absolute z-30 top-full right-0 mt-1 w-[280px] max-w-[calc(100vw-2rem)] rounded-lg bg-tea-surface border border-tea-border shadow-2xl p-3"
                      >
