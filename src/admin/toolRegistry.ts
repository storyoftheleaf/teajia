...
export const ADMIN_TOOLS: AdminTool[] = [
  ...
  { id: 'inventory', label: 'Stock', group: 'sell', route: '/admin/stock', addedAt: '2025-09-15', bundle: 'stock' },
  ...
  { id: 'contributors', label: 'Contributors', group: 'publish', route: '/admin/contributors', addedAt: '2026-07-13', requires: 'owner' },
