...
- `worker/migrations/123_tea_master_profiles.sql` — contributor associations, languages, public favorites, payment methods.
- `worker/migrations/124_wisdom_relations.sql` — Wisdom overrides/relations and idempotent article-product xref schema.
...
**Files:**
- Create: `worker/migrations/123_tea_master_profiles.sql`
- Create: `worker/migrations/124_wisdom_relations.sql`
