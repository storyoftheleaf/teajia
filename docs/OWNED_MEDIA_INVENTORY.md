...
Generated from the pre-removal runtime scan on 2026-07-13. This ledger records every Unsplash or Picsum occurrence that was browser-delivered at the start of Release 3. Rows remain here after safe removal so the evidence trail is complete.

Verified checked-in media reviewed: `public/og-image.png`, `public/favicon.svg`, `public/logos/*`, and `public/textures/*`. Each exists, but none is a truthful content replacement for the editorial, product, person, or place photography below. No unverified `/media/*` path is proposed.

| Source file:line | Screen/content owner | Current host | Disposition | Verified owned path | Verification evidence |
|---|---|---|---|---|---|
| `src/AboutPage.tsx:74` | /about founder portrait | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:44` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:46` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:47` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:71` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:73` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:74` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:99` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:118` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/designPortfolio.ts:137` | /advise design portfolio | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/oracleCards.ts:20` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/oracleCards.ts:38` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/components/StoryModal.tsx:69` | legacy audio story modal fallback | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/content/people.ts:9` | browser-delivered contributor fixtures | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/content/people.ts:16` | browser-delivered contributor fixtures | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/content/people.ts:23` | browser-delivered contributor fixtures | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/content/people.ts:30` | browser-delivered contributor fixtures | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/content/people.ts:37` | browser-delivered contributor fixtures | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:8` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:31` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:56` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:79` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:99` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:121` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:141` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/galleryData.ts:163` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:54` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:73` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:92` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:113` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:132` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:150` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:167` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:184` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:203` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:220` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:237` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:256` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:274` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:292` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:315` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:336` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:357` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/shop-products.ts:378` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:19` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:29` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:38` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:47` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:58` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:68` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:78` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/readingList.ts:89` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
...
| `src/data/collectionItems.ts:25` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:39` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:55` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:70` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:86` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:99` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:112` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/collectionItems.ts:127` | /shop or /collection catalog demo data | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
...
| `src/data/teaInspire.ts:34` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:58` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:75` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:97` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:107` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:130` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:154` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:171` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/data/teaInspire.ts:189` | browser-delivered community/gallery content | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
...
| `src/components/LearnLibrary.tsx:51` | /learn library | `images.unsplash.com` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/components/ResourcesPage.tsx:26` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/ResourcesPage.tsx:34` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/ResourcesPage.tsx:42` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/ResourcesPage.tsx:50` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/ResourcesPage.tsx:58` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/ResourcesPage.tsx:66` | legacy Resources community directory | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/components/admin-panel/pageUtils.ts:8` | admin story draft default | `picsum.photos` | remove | — | Removed; token/text fallback is checked in and build-verified. |
| `src/constants.ts:225` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:240` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:256` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:271` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:286` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:302` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:322` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:339` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:355` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:372` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:392` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:409` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:426` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
| `src/constants.ts:442` | legacy browser-delivered story catalog | `picsum.photos` | blocked-editorial | — | No content-matched checked-in asset exists; pending Adrian-owned media. |
