...
- [x] **Customer profile: show events attended**
...
- [x] **Customer list: "attended events" filter/segment**
...
- [x] **Product detail: "Featured in X events" section**
...
- [x] **Flow event TastingNotes into customer tasting journal**
...
- [x] **Product cards: "You tasted this X times" badge**
...
- [x] **Invoices: add optional `source_event_id`**
